...
function adicionarProduto($nome, $descricao, $tipo, $preco){

	$comando = "INSERT INTO tblproduto (nomeproduto, descricao, tipoproduto, preco)
...
function editarProduto($id, $nome, $descricao, $tipo, $preco){
	$comando = "UPDATE tblproduto SET nomeproduto = '$nome', descricao = '$descricao', tipoproduto = '$tipo',  preco = '$preco'
	WHERE idProduto ='$id'";
	$retorno = mysqli_query($cnx = conn(), $comando);
